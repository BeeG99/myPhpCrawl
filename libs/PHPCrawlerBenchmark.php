...
class PHPCrawlerBenchmark
{
     ...
     * @param string $identifier The benchmark name/identifier.
     */
     ...
     * @internal param array $retain_benachmarks Optional. Numeric array containing benchmark-identifiers that should NOT get resetted.
     */
