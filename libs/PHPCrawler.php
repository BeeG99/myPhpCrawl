...
use Exception;
use PHPCrawler\CookieCache\PHPCrawlerCookieCacheBase;
...
use PHPCrawler\UrlCache\PHPCrawlerMemoryURLCache;
use PHPCrawler\UrlCache\PHPCrawlerSQLiteURLCache;
